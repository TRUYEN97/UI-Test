...
{
    public class PropertyModelView : BaseModelView, IKeyValue
    {
        ...
        public string Value { get => _value; set { _value = value; OnPropertyChanged(); Command.RaiseCanExecuteChanged(); } }
    }
}
